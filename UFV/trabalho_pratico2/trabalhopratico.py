...
while True:
    ...
    if comando == 3:
        ...
        cancelados = 0
        for ficha in atendimentos:
            if ficha[4] == 'concluido':
                total_arrecadado += ficha[3]
            if ficha[4] == 'cancelado':
                cancelados += 1
        print (f'\nTotal de atendimentos registrados: {total_atendimentos}')
        print(f'Total de dinheiro arrecadado com atendimentos concluidos: {total_arrecadado}')
